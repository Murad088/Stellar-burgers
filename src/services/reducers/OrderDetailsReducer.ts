import { CLOSE_ORDER_DETAILS_MODAL, OPEN_ORDER_DETAILS_MODAL, POST_ORDER_FAILED, POST_ORDER_REQUEST, POST_ORDER_SUCCESS, TOrderActions, TOrderData, } from "../actions/OrderDetailsAction";
